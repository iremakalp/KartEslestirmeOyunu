...
--
-- Host: 127.0.0.1    Database: kartesleme
-- ------------------------------------------------------
...
CREATE TABLE `tbl_oyuncular` (
  ...
  `Seviye` varchar(125) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `Puan` int NOT NULL,
...
INSERT INTO `tbl_oyuncular` VALUES (1,'İrem Akalp','Kolay',300,6,'20'),(2,'Can','Kolay',280,9,'31'),(3,'Cansu','Orta',365,14,'91'),(4,'Melis','Zor',345,19,'0'),(5,'Mehmet','Zor',435,22,'122'),(6,'Dicle','Orta',0,0,'104');
...
-- Dump completed on 2021-05-25 21:28:48
